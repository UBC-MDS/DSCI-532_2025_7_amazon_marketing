...
Ratings_chart = dbc.Card(
    [dbc.CardHeader('User Ratings Overview',
                    style={"textAlign": "left",
                           'paddingLeft': '20px',
                           'fontWeight': 'bold'}),
     dbc.CardBody(html.Div([dvc.Vega(id='rating_graph', spec={})]))],
...
Purchase_history_chart = dbc.Card(
    [dbc.CardHeader('User Purchase History',
                    style={"textAlign": "left",
                          'paddingLeft': '20px', 
                          'fontWeight': 'bold'}),
     dbc.CardBody(html.Div([dvc.Vega(id='purchase_graph', spec={})]))],
...
Engagement_chart = dbc.Card(
    [dbc.CardHeader('User Engagement Levels',
                    style={"textAlign": "left",
                           'fontWeight': 'bold'}),
    dbc.CardBody(html.Div([dvc.Vega(id='engagement_graph', spec={})]))],
