...
Ratings_chart = html.Div([
    ...
    html.Div(
    dvc.Vega(id='rating_graph', spec={}, style={"height": '24vh', "border": "1px solid lightgrey", "border-bottom-left-radius": "8px", "border-bottom-right-radius": "8px", 'backgroundColor': 'white', 'padding': '2vh', 'paddingRight': '3vh'})
...
Engagement_chart = html.Div([
    ...
    html.Div(
        dvc.Vega(id='engagement_graph', spec={}, style={"height": '18vh', "border": "1px solid lightgrey", "border-bottom-left-radius": "8px", "border-bottom-right-radius": "8px", 'backgroundColor': 'white', 'padding': '2vh', 'paddingRight': '3vh'})
