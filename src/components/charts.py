...
Ratings_chart = dbc.Card(
    [dbc.CardHeader('User Ratings Overview',
                    style={"textAlign": "left",
                           'paddingLeft': '2vw',
                           'fontWeight': 'bold'}),
     dbc.CardBody([dcc.Loading(dvc.Vega(id='rating_graph', spec={}, style={"height": '20vh'}, opt={'actions': False}))])],
...
Purchase_history_chart = dbc.Card(
    [dbc.CardHeader('User Purchase History',
                    style={"textAlign": "left",
                          'paddingLeft': '2vw', 
                          'fontWeight': 'bold'}),
     dbc.CardBody([dcc.Loading(dvc.Vega(id='purchase_graph', spec={}, style={"height": '20vh'}, opt={'actions': False}))])],
...
Engagement_chart = dbc.Card(
    [dbc.CardHeader('User Engagement Levels',
                    style={"textAlign": "left",
                           'fontWeight': 'bold'}),
     dbc.CardBody([dcc.Loading(dvc.Vega(id='engagement_graph', spec={}, style={"height": '15vh'}, opt={'actions': False}))])],
